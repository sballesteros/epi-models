...
module.exports = function(options){
  ...
  var blocks = {
    ...
    recovery: [
      {from: 'I', to: 'R', rate: 'correct_rate(v)', comment: 'progression to recovery'}
    ],

    recovery_Q: [
      {from: 'I', to: 'Q', rate: 'correct_rate(v)', comment: 'progression to temporary full cross immunity'}
    ],

    waning_Q: [
      {from: 'Q', to: 'R', rate: 'correct_rate(q)', , comment: 'progression from full cross immunity to recovery'}
    ],

    waning_immunity: [
      {from: 'R', to: 'S', rate: 'g', comment: 'loss of immunity'}
    ],
