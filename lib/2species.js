...
module.exports = function(options){
  ...
  var I1 = ['IS', 'IR']
    , I2 = ['SI', 'RI']
    , inf1 = util.format('r0_1/N*v_1*(1.0 +e*sin(2.0*M_PI*(t/ONE_YEAR + d)))*(%s + iota_1)', I1.join('+'))
    , inf2 = util.format('r0_2/N*v_2*(1.0 +e*sin(2.0*M_PI*(t/ONE_YEAR + d)))*(%s + iota_2)', I2.join('+'));
  ...
  var parameters = [
    ...
    {id:'v_1',    comment: 'recovery rate of strain 1'},
    {id:'v_2',    comment: 'recovery rate of strain 2'},
  ...
  var blocks = {
    ...
    recovery: [
      {from: 'IS', to: 'RS', rate: 'correct_rate(v_1)', comment: 'progression to recovered'},
      {from: 'SI', to: 'SR', rate: 'correct_rate(v_2)', comment: 'progression to recovered'},
      {from: 'IR', to: 'RR', rate: 'correct_rate(v_1)', comment: 'progression to recovered'},
      {from: 'RI', to: 'RR', rate: 'correct_rate(v_2)', comment: 'progression to recovered'}
    ],

    recovery_Q: [
      {from: 'IS', to: 'QS', rate: 'correct_rate(v_1)', comment: 'progression to temporary full cross immunity'},
      {from: 'SI', to: 'SQ', rate: 'correct_rate(v_2)', comment: 'progression to temporary full cross immunity'},
      {from: 'IR', to: 'QR', rate: 'correct_rate(v_1)', comment: 'progression to temporary full cross immunity'},
      {from: 'RI', to: 'RQ', rate: 'correct_rate(v_2)', comment: 'progression to temporary full cross immunity'}
    ],

    waning_Q: [
      {from: 'QS', to: 'RS', rate: 'correct_rate(q)', comment: 'loss of full cross immunity and progression to recovery'},
      {from: 'SQ', to: 'SR', rate: 'correct_rate(q)', comment: 'loss of full cross immunity and progression to recovery'},
      {from: 'QR', to: 'RR', rate: 'correct_rate(q)', comment: 'loss of full cross immunity and progression to recovery'},
      {from: 'RQ', to: 'RR', rate: 'correct_rate(q)', comment: 'loss of full cross immunity and progression to recovery'}
    ],

    waning_immunity: [
      {from: 'IR', to: 'IS', rate: 'g', comment: 'loss of immunity'},
      {from: 'RI', to: 'SI', rate: 'g', comment: 'loss of immunity'},
      {from: 'SR', to: 'SS', rate: 'g', comment: 'loss of immunity'},
      {from: 'RS', to: 'SS', rate: 'g', comment: 'loss of immunity'},
      {from: 'RR', to: 'RS', rate: 'g', comment: 'loss of immunity'},
      {from: 'RR', to: 'SR', rate: 'g', comment: 'loss of immunity'}
    ],

    waning_immunity_E: [
      {from: 'ER', to: 'ES', rate: 'g', comment: 'loss of immunity'},
      {from: 'RE', to: 'SE', rate: 'g', comment: 'loss of immunity'},
    ],

    waning_immunity_Q: [
      {from: 'QR', to: 'QS', rate: 'g', comment: 'loss of immunity'},
      {from: 'RQ', to: 'SQ', rate: 'g', comment: 'loss of immunity'},
    ],
