...
module.exports = function(options){
  ...
  var blocks = {
    ...
    recovery: [
      {from: 'IS', to: 'RS', rate: 'correct_rate(v)', comment: 'progression to recovered'},
      {from: 'SI', to: 'SR', rate: 'correct_rate(v)', comment: 'progression to recovered'},
      {from: 'IR', to: 'RR', rate: 'correct_rate(v)', comment: 'progression to recovered'},
      {from: 'RI', to: 'RR', rate: 'correct_rate(v)', comment: 'progression to recovered'}
    ],

    recovery_Q: [
      {from: 'IS', to: 'QS', rate: 'correct_rate(v)', comment: 'progression to temporary full cross immunity'},
      {from: 'SI', to: 'SQ', rate: 'correct_rate(v)', comment: 'progression to temporary full cross immunity'},
      {from: 'IR', to: 'QR', rate: 'correct_rate(v)', comment: 'progression to temporary full cross immunity'},
      {from: 'RI', to: 'RQ', rate: 'correct_rate(v)', comment: 'progression to temporary full cross immunity'}
    ],
